...
include(opencv_human_detection.pri)
...
OPENCV_DATA_HUMAN_HAAR_PATH = $${PWD}/../../3rdparty/opencv/data/haarcascades
OPENCV_DATA_HUMAN_HOG_PATH  = $${PWD}/../../3rdparty/opencv/data/hogcascades
BUILD_DIR                   = $${DESTDIR}
...
win32-msvc2012{
    !contains(QMAKE_TARGET.arch, x86_64) {
        ...
        CONFIG(debug, debug|release){
            ...
            for( files, OPENCV_DATA_HUMAN_HAAR ):eval( QMAKE_POST_LINK += xcopy /R /Q /Y /I $$replace( OPENCV_DATA_HUMAN_HAAR_PATH, /, \\ )\\$${files} $$replace( BUILD_DIR, /, \\ ) & )
            export(QMAKE_POST_LINK)
